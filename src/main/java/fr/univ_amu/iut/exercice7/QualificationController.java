...
public class QualificationController {
  ...
  private void initialize() {
    ...
    colHorodatage.setCellValueFactory(
        c -> new SimpleStringProperty(String.valueOf(c.getValue().getHorodatage().format(HEURE))));
    ...
    // 2. Abonner le tableau à la liste observable :
    ...
    Bindings.bindBidirectional(zoneCommentaire.textProperty(), viewModel.commentaireProperty());
    ...
    Bindings.bindBidirectional(choiceVerdict.valueProperty(), viewModel.verdictSaisiProperty());
