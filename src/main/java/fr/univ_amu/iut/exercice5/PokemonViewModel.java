...
public class PokemonViewModel {
  ...
  public PokemonViewModel(PokemonService service) {
    ...
    pokemons.setAll(service.tousLesPokemons()); // On ajoute les pokemons à la liste observable
    resume.bind(Bindings.size(pokemons).asString().concat(" Pokémon")); // Mise à jour du résumé
  }
